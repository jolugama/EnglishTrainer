    ...
    var methods = {
        ...
        drawTimer: function(percent) {
            ...
            if (data) {
                ...
                //aqui se cambia para que pase los números de 10 en 10 o de uno en uno $this.find('.percent').html(Math.round(percent) + '%');
                $this.find('.percent').html(Math.round(percent / 10) * 10 + '%');
        ...
        start: function() {
            ...
            if (data) {
                ...
                data.timer = setInterval("$this.pietimer('stopWatch')", 1000);
            }
        },
        reset: function() {
            var data = $(this).data('pietimer');
